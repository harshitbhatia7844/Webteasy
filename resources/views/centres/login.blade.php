                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-transparent text-white" style="border-radius: 1.5rem; border:1px solid white;">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 py-3">

                                <img src="../images/montage.png" alt="">
                                <form action={{ route('centre.signin') }} method="post">
                                    @csrf
                                    <h2 class="fw-bold my-2 text-uppercase text-info">Centre Login</h2>
                                    ...
                                    <input type="txt" id="" name="status" value="0" hidden />

                                    <p class="small mb-5 pb-lg-2"><a class="text-white-50"
                                            href="{{ route('centre.forgotpassword') }}">Forgot password?</a></p>
                            ...
                            <div>
                                ...
                                <p class="small mb-2 pb-lg-2"><a class="text-white-50" href="{{ route('welcome') }}">&larr;
                                        Back to Home</a></p>
                            </div>
